...
@click.option('-L', '--LINE', is_flag=True, help="The line number that caused the exception will be displayed alone. like the --line option, has conditions to be combined.")
...
@click.option('-C', '--CODE', is_flag=True, help="The code that caused the exception will be displayed alone. This option, like the --line option, has conditions to be combined.")
...
@click.option('-F', '--FILE', is_flag=True, help="The full path of the python file that was interpreted and has an error will be displayed alone. This option, like the --line option, has conditions to be combined.")
